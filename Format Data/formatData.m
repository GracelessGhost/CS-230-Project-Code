...
isUsingSaccades = true;

isUsingCali = false;
customScaleCh1 = 95.05;
customScaleCh2 = 0;

isRemovingSegment = false;
removeTime = [700, 1470]; % Seconds (start, stop)
...
% Timescale
if isCropping
    magnetPos = magnetPos(cropTime(1) * 1000 + 1:cropTime(2) * 1000); % Crop timescale
end
